...
import { createSupplierSchema, CreateSupplierInput } from '@/lib/validations/inventory';
...
export default function CreateSupplierPage() {
  ...
  const onSubmit = async (data: CreateSupplierInput) => {
    try {
      ...
      toast.success(t('messages.createSuccess', { entity: t('suppliers.title') }));
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder={t('suppliers.supplierName')} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <div className="flex items-center justify-end gap-3">
            <Button type="button" variant="outline" onClick={() => router.push(`/${locale}/suppliers`)}>
              {t('common.cancel')}
            </Button>
