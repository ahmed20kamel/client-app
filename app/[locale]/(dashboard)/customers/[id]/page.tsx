          ...
          <CardContent className="pt-5 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xl font-bold truncate">{customer.estimatedValue ? `AED ${customer.estimatedValue.toLocaleString()}` : '-'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-5 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xl font-bold text-green-600 truncate">{customer.weightedValue ? `AED ${customer.weightedValue.toLocaleString()}` : '-'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <Card className="shadow-premium">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  <InfoItem icon={User} label={t('customers.fullName')} value={customer.fullName} />
                  ...
                  <InfoItem icon={User} label={t('customers.customerType')} value={t(`customers.type${customer.customerType.charAt(customer.customerType.length - 1)}`)} />
                  ...
                  <InfoItem icon={Calendar} label={t('common.createdAt')} value={new Date(customer.createdAt).toLocaleDateString()} />
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="shadow-premium">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <InfoItem icon={DollarSign} label={t('customers.estimatedValue')} value={customer.estimatedValue ? `AED ${customer.estimatedValue.toLocaleString()}` : null} />
                <InfoItem icon={Percent} label={t('customers.probability')} value={customer.probability != null ? `${customer.probability}%` : null} />
                <InfoItem icon={TrendingUp} label={t('customers.weightedValue')} value={customer.weightedValue ? `AED ${customer.weightedValue.toLocaleString()}` : null} />
                <InfoItem icon={Calendar} label={t('customers.lastFollowUp')} value={customer.lastFollowUp ? new Date(customer.lastFollowUp).toLocaleDateString() : null} />
                <InfoItem icon={Calendar} label={t('customers.nextFollowUp')} value={customer.nextFollowUp ? new Date(customer.nextFollowUp).toLocaleDateString() : null} />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
