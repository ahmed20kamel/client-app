...
export default function EditEmployeePage() {
  ...
  const [form, setForm] = useState<any>({
    empCode: '', name: '', visaType: '', costCenter: '', wpsEntity: '',
    paymentMethod: '', status: '', startDate: '',
    basicSalary: '', allowances: '', otherAllowance: '', hoursPerDay: '', remarks: '',
  });
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            <span className="font-mono text-primary">{form.empCode}</span> · {form.costCenter}
          </p>
        </div>
      </div>
        ...
        <div className="bg-card rounded-xl border border-border p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Field label="Employee Code">
              <input value={form.empCode} onChange={e => set('empCode', e.target.value)} className={inputCls} />
            </Field>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Field label="Basic Salary">
              <input type="number" min="0" step="0.01" value={form.basicSalary}
                onChange={e => set('basicSalary', e.target.value)} className={inputCls} />
            </Field>
            ...
            <Field label="Other Allowance">
              <input type="number" min="0" step="0.01" value={form.otherAllowance}
                onChange={e => set('otherAllowance', e.target.value)} className={inputCls} />
            </Field>
          </div>
        </div>
